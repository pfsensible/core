...
class TestPFSenseAuthserverLDAPModule(TestPFSenseModule):
    ...
    def check_target_elt(self, obj, target_elt):
        ...
        self.check_param_equal(
            obj, target_elt, "port", xml_field="ldap_port", default=389
        )
        self.assert_xml_elt_equal(target_elt, "ldap_urltype", urltype[obj["transport"]])
        self.check_param_equal(
            obj, target_elt, "protover", xml_field="ldap_protver", default=3
        )
        self.check_param_equal(
            obj, target_elt, "scope", xml_field="ldap_scope", default="one"
        )
        self.check_param_equal(
            obj, target_elt, "basedn", xml_field="ldap_basedn", default=None
        )
        ...
        self.check_param_bool(
            ...
            target_elt,
            "extended_enabled",
            xml_field="ldap_extended_enabled",
            value_true="yes",
        )
        self.check_param_equal(
            obj, target_elt, "extended_query", xml_field="ldap_extended_query"
        )
        self.check_param_equal(
            obj, target_elt, "attr_user", xml_field="ldap_attr_user", default="cn"
        )
        self.check_param_equal(
            obj, target_elt, "attr_group", xml_field="ldap_attr_group", default="cn"
        )
        self.check_param_equal(
            obj,
            target_elt,
            "attr_member",
            xml_field="ldap_attr_member",
            default="member",
        )
        self.check_param_equal(
            obj,
            target_elt,
            "attr_groupobj",
            xml_field="ldap_attr_groupobj",
            default="posixGroup",
        )
        self.check_param_equal(
            obj, target_elt, "pam_groupdn", xml_field="ldap_pam_groupdn", default=None
        )
        self.check_param_bool(
            obj,
            target_elt,
            "ldap_allow_unauthenticated",
            xml_field="ldap_allow_unauthenticated",
            default=True,
        )
        self.check_param_equal(
            obj, target_elt, "timeout", xml_field="ldap_timeout", default=25
        )
    ...
    def test_authserver_create(self):
        ...
        self.do_module_test(
            obj, command="create authserver_ldap 'authserver1', host='ldap.example.com'"
        )
    ...
    def test_authserver_delete(self):
        ...
        self.do_module_test(
            obj, command="delete authserver_ldap 'DELLDAP'", delete=True
        )
    ...
    def test_authserver_update_noop(self):
        ...
        self.do_module_test(
            obj, command="delete authserver_ldap 'DELLDAP'", changed=False
        )
    ...
    def test_authserver_update_host(self):
        ...
        self.do_module_test(
            obj, command="update authserver_ldap 'DELLDAP' set host='ldap2.blah.com'"
        )
    ...
    def test_authserver_disable_allow_unauthenticated(self):
        ...
        self.do_module_test(
            obj,
            command="update authserver_ldap 'DELLDAP' set ldap_allow_unauthenticated=False",
        )
    ...
    def test_create_authserver_invalid_timeout(self):
        ...
        self.do_module_test(
            obj,
            command="update authserver_ldap 'DELLDAP'",
            failed=True,
            msg="timeout 0 must be greater than 1",
        )
