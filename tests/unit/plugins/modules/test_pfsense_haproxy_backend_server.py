...
class TestPFSenseHaproxyBackendServerModule(TestPFSenseModule):
    ...
    def test_haproxy_backend_server_update_frontend(self):
        ...
        server = dict(
            backend="test-backend", name="exchange.acme.org", forwardto="test-frontend"
        )
    ...
    def test_haproxy_backend_server_update_certs(self):
        ...
        server = dict(
            backend="test-backend",
            name="exchange2.acme.org",
            address="exchange2.acme.org",
            port=443,
            ca="test ca2",
            clientcert="test cert2",
            crl="test crl2",
        )
    ...
    def test_haproxy_backend_server_invalid_frontend(self):
        """test updating certs"""
        server = dict(
            backend="test-backend", name="exchange", forwardto="test frontend"
        )
