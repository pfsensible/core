...
class TestPFSenseRuleUpdateModule(TestPFSenseRuleModule):
    ...
    def test_rule_update_floating_interface(self):
        ...
        command = (
            "update rule 'test_rule_floating' on 'floating(wan)' set interface='lan'"
        )
        self.do_module_test(obj, command=command)
    ...
    def test_rule_update_floating_direction(self):
        ...
        command = (
            "update rule 'test_rule_floating' on 'floating(wan)' set direction='out'"
        )
        self.do_module_test(obj, command=command)
    ...
    def test_rule_update_floating_remove_quick(self):
        ...
        command = (
            "update rule 'test_rule_floating_quick' on 'floating(wan)' set quick=False"
        )
        self.do_module_test(obj, command=command)
    ...
    def test_rule_update_protocol_any(self):
        """test updating protocol of a rule to udp"""
        obj = dict(
            name="r2", source="any", destination="any", interface="vt1", protocol="any"
        )
    ...
    def test_rule_update_icmp(self):
        ...
        command = (
            "update rule 'r1' on 'vt1' set protocol='icmp', icmptype='echorep,echoreq'"
        )
        self.do_module_test(obj, command=command)
