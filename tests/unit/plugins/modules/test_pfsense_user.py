...
class TestPFSenseUserModule(TestPFSenseModule):
    ...
    def test_user_create(self):
        ...
        obj = dict(
            name="user1",
            descr="User One",
            password="$2b$12$D2jkq4Iut3ODUBN0BCrDk.bV3J5N.MrY5YEnGvTXwxeNBkyxjbbtW",
        )
        self.do_module_test(
            obj, command="create user 'user1', descr='User One', uid='2001'"
        )
    ...
    def test_create_user_invalid_password(self):
        ...
        self.do_module_test(
            obj,
            command="update user 'testdel'",
            failed=True,
            msg="Password (password) does not appear to be a bcrypt hash",
        )
