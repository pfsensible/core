...
from ansible_collections.pfsensible.core.plugins.modules.pfsense_dns_resolver import (
    PFSenseDNSResolverModule,
)
...
class TestPFSenseDNSResolverModule(TestPFSenseModule):
    ...
    def setUp(self):
        ...
        self.php.return_value = {
            "wan": "WAN",
            "lan": "LAN",
            "_llocwan": "WAN IPv6 Link-Local",
            "_lloclan": "LAN IPv6 Link-Local",
            "lo0": "Localhost",
        }
    ...
    def check_target_elt(self, obj, target_elt, target_idx=-1):
        ...
        self.check_param_equal(
            obj, target_elt, "unwanted_reply_threshold", default="disabled"
        )
    ...
    def test_dns_resolver_init(self):
        ...
        obj = dict()
        command_as_list = [
            "update dns_resolver pfsense_dns_resolver set active_interface='all', "
    ...
    def test_dns_resolver_change(self):
        ...
        obj = dict(active_interface=["lan", "lo0"], outgoing_interface=["wan"])
        command_as_list = [
            "update dns_resolver pfsense_dns_resolver set active_interface='lan,lo0', outgoing_interface='wan'"
        ]
        command = "".join(command_as_list)
        self.do_module_test(obj, command=command)
	...
	"""  # noqa: E101,W191
        self.do_module_test(
            obj, command=command, expected_elt_string=expected_elt_string
        )
