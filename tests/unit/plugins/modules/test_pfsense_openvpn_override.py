...
class TestPFSenseOpenVPNOverrideModule(TestPFSenseModule):
    ...
    def get_target_elt(self, obj, absent=False, module_result=None):
        ...
        if len(result) == 1:
            ...
            self.fail(
                "Found multiple OpenVPN overrides for name {0}.".format(obj["name"])
            )
        else:
            return None
    ...
    def check_target_elt(self, obj, target_elt):
        ...
        self.check_param_bool(
            obj, target_elt, "push_reset", default=False, value_true="yes"
        )
    ...
    def test_openvpn_override_create(self):
        ...
        self.do_module_test(
            obj, command="create openvpn_override 'vpnuser1', common_name='vpnuser1'"
        )
    ...
    def test_openvpn_override_delete(self):
        ...
        self.do_module_test(
            obj, command="delete openvpn_override 'delvpnuser'", delete=True
        )
    ...
    def test_openvpn_override_update_noop(self):
        ...
        obj = dict(
            ...
            gwredir=True,
            server_list=1,
            custom_options="ifconfig-push 10.8.0.1 255.255.255.0",
        )
