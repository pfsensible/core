...
class TestPFSenseRuleCreateModule(TestPFSenseRuleModule):
    ...
    def test_rule_create_log(self):
        ...
        obj = dict(
            name="one_rule", source="any", destination="any", interface="lan", log="yes"
        )
        command = (
            "create rule 'one_rule' on 'lan', source='any', destination='any', log=True"
        )
        self.do_module_test(obj, command=command)
    ...
    def test_rule_create_nolog(self):
        ...
        obj = dict(
            name="one_rule", source="any", destination="any", interface="lan", log="no"
        )
        command = "create rule 'one_rule' on 'lan', source='any', destination='any'"
        self.do_module_test(obj, command=command)
    ...
    def test_rule_create_source_alias(self):
        ...
        obj = dict(
            name="one_rule", source="srv_admin", destination="any", interface="lan"
        )
        command = (
            "create rule 'one_rule' on 'lan', source='srv_admin', destination='any'"
        )
        self.do_module_test(obj, command=command)
    ...
    def test_rule_create_source_urltable_alias(self):
        ...
        obj = dict(
            name="one_rule", source="acme_corp", destination="any", interface="lan"
        )
        command = (
            "create rule 'one_rule' on 'lan', source='acme_corp', destination='any'"
        )
        self.do_module_test(obj, command=command)
    ...
    def test_rule_create_destination_alias(self):
        ...
        obj = dict(
            name="one_rule", source="any", destination="srv_admin", interface="lan"
        )
        command = (
            "create rule 'one_rule' on 'lan', source='any', destination='srv_admin'"
        )
        self.do_module_test(obj, command=command)
    ...
    def test_rule_create_destination_ip_invalid(self):
        ...
        obj = dict(
            name="one_rule",
            source="any",
            destination="192.193.194.195.196",
            interface="lan",
        )
        msg = "Cannot parse address 192.193.194.195.196, not IP or alias"
        self.do_module_test(obj, failed=True, msg=msg)
    ...
    def test_rule_create_destination_net_invalid(self):
        ...
        obj = dict(
            name="one_rule",
            source="any",
            destination="192.193.194.195/256",
            interface="lan",
        )
        msg = "Cannot parse address 192.193.194.195/256, not IP or alias"
        self.do_module_test(obj, failed=True, msg=msg)
    ...
    def test_rule_create_net_interface(self):
        ...
        obj = dict(
            name="one_rule", source="NET:lan", destination="any", interface="lan"
        )
    ...
    def test_rule_create_ip_interface_invalid(self):
        """test creation of a new rule with invalid interface"""
        obj = dict(
            name="one_rule", source="IP:invalid_lan", destination="any", interface="lan"
        )
        msg = "invalid_lan is not a valid interface"
        self.do_module_test(obj, failed=True, msg=msg)
    ...
    def test_rule_create_port_alias(self):
        ...
        obj = dict(
            name="one_rule",
            source="10.10.1.1",
            destination="10.10.10.1:port_http",
            interface="lan",
            protocol="tcp",
        )
    ...
    def test_rule_create_urltable_port_alias(self):
        ...
        obj = dict(
            name="one_rule",
            source="10.10.1.1",
            destination="10.10.10.1:acme_corp_ports",
            interface="lan",
            protocol="tcp",
        )
    ...
    def test_rule_create_port_alias_range(self):
        ...
        obj = dict(
            name="one_rule",
            source="10.10.1.1:port_ssh-port_http",
            destination="10.10.10.1",
            interface="lan",
            protocol="tcp",
        )
    ...
    def test_rule_create_port_alias_range_invalid_1(self):
        ...
        obj = dict(
            name="one_rule",
            source="10.10.1.1:port_ssh-openvpn_port",
            destination="10.10.10.1",
            interface="lan",
        )
    ...
    def test_rule_create_port_alias_range_invalid_3(self):
        ...
        obj = dict(
            name="one_rule",
            source="10.10.1.1:port_ssh-65537",
            destination="10.10.10.1",
            interface="lan",
        )
    ...
    def test_rule_create_gateway_invalid_ipprotocol(self):
        ...
        msg = (
            'Gateway "GW_LAN" does not exist or does not match target rule ip protocol.'
        )
        self.do_module_test(obj, failed=True, msg=msg)
