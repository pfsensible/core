...
class TestPFSenseIpsecP2Module(TestPFSenseModule):
        ...
        if phase2.get(param_name):
            ...
            if phase2.get(param_name + "_len") is not None:
                ...
                if keylen_elt is None:
                    self.fail(
                        "Key length not found for encryption named {0}".format(enc_name)
                    )
    ...
    def test_phase2_update_disable_aes(self):
        ...
        command = (
            "update ipsec_p2 'one_p2' on 'test_tunnel' set aes=False, aes_len=none"
        )
        self.do_module_test(phase2, command=command)
    ...
    def test_phase2_tunnel6_remote(self):
        ...
        msg = (
            "A valid IPv6 address or network must be specified in remote with tunnel6."
        )
        self.do_module_test(ipsec, msg=msg, failed=True)
    ...
    def test_phase2_tunnel_remote(self):
        ...
        ipsec = dict(
            ...
            mode="tunnel",
            local="lan",
            remote="fd69:81a5:a5:7396:0:0:0:0",
            aes="True",
            aes_len="128",
            aes128gcm=True,
            aes128gcm_len="128",
    ...
    def test_phase2_tunnel_remote2(self):
        ...
        ipsec = dict(
            ...
            mode="tunnel",
            local="lan",
            remote="fd69:81a5:a5:7396:0:0:0:0/64",
            aes="True",
            aes_len="128",
            aes128gcm=True,
            aes128gcm_len="128",
    ...
    def test_phase2_tunnel_local(self):
        ...
        ipsec = dict(
            ...
            descr="one_p2",
            mode="tunnel",
            local="fd69:81a5:a5:7396:0:0:0:0",
            remote="10.20.30.40/24",
            aes="True",
            aes_len="128",
            aes128gcm=True,
