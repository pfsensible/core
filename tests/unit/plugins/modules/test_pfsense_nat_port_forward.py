...
class TestPFSenseNatPortForwardModule(TestPFSenseModule):
    ...
    def check_target_elt(self, obj, target_elt, target_idx=-1):
        ...
        self.check_param_equal_or_not_find(
            obj, target_elt, "natreflection", not_find_val="system-default"
        )
    ...
    def test_nat_port_forward_create_range(self):
        ...
        obj = dict(
            descr="test_pf",
            interface="lan",
            source="any:9000-10000",
            destination="1.2.3.4:9000-10000",
            target="2.3.4.5:9000",
    ...
    def test_nat_port_forward_update_noop(self):
        ...
        obj = dict(
            ...
            interface="wan",
            source="any",
            destination="IP:wan:22022",
            target="10.255.1.20:22",
            associated_rule="none",
        )
