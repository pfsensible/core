...
from ansible_collections.pfsensible.core.plugins.module_utils.gateway import (
    PFSenseGatewayModule,
)
...
class TestPFSenseGatewayModule(TestPFSenseModule):
    ...
    def check_target_elt(self, obj, target_elt):
        ...
        self.check_param_equal_or_not_find(
            obj, target_elt, "monitor_disable", empty=True
        )
        self.check_param_equal_or_not_find(
            obj, target_elt, "action_disable", empty=True
        )
        self.check_param_equal_or_not_find(obj, target_elt, "force_down", empty=True)
        self.check_param_equal_or_not_find(
            obj, target_elt, "nonlocalgateway", empty=True
        )
    ...
    def test_gateway_create_ipv6(self):
        """test"""
        obj = dict(
            name="test_gw", interface="wan", ipprotocol="inet6", gateway="2001::1"
        )
    ...
    def test_gateway_create_nonlocal(self):
        """test"""
        obj = dict(
            name="test_gw", interface="lan", gateway="1.2.3.4", nonlocalgateway=True
        )
    ...
    def test_gateway_create_invalid_monitor(self):
        """test"""
        obj = dict(
            name="test_gw", interface="lan", gateway="192.168.1.1", monitor="2001::1"
        )
    ...
    def test_gateway_create_invalid_ipv6(self):
        """test"""
        obj = dict(
            name="test_gw", interface="lan", gateway="2001::1", ipprotocol="inet6"
        )
    ...
    def test_gateway_create_invalid_ipv6_2(self):
        """test"""
        obj = dict(
            name="test_gw", interface="wan", gateway="192.168.1.2", ipprotocol="inet6"
        )
